        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              {/* --- CAMBIO AQUÍ: Se ajustó la altura de línea (line-height) --- */}
              <span className="text-[0.6rem] sm:text-xs font-semibold leading-tight text-gray-800">AÑOS CONSTRUYENDO CONFIANZA</span>
            </motion.div>
          </motion.div>
